...
python3 scripts/import_sgu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_sgu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
...
python3 scripts/import_scau_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_scau_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_hzu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_hzu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_gdei_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_gdei_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_gzmtu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_gzmtu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
...
python3 scripts/import_gpnu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_gpnu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
...
python3 scripts/import_szpu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_szpu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_zqmc_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_zqmc_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_gzucm_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_gzucm_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_gdpu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_gdpu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_lingnan_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_lingnan_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_hstc_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_hstc_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_zqu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_zqu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_jyu_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_jyu_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_zhku_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_zhku_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_special_reference_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_special_reference_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/import_gaokao_cn_major_scores.py --data-dir assets/pilot-data/guangdong-physics --track 物理类 --replace-existing
python3 scripts/import_gaokao_cn_major_scores.py --data-dir assets/pilot-data/guangdong-history --track 历史类 --replace-existing
python3 scripts/sync_major_profiles_from_admissions.py --data-dir assets/pilot-data/guangdong-physics --data-dir assets/pilot-data/guangdong-history --output-dir assets/data --output-dir assets/pilot-data/guangdong-physics --output-dir assets/pilot-data/guangdong-history --output-dir assets/pilot-data/zhejiang-ordinary --output-dir assets/pilot-data/shandong-ordinary --output-dir assets/pilot-data/beijing-ordinary --output-dir assets/pilot-data/shanghai-ordinary
...
Do not promote a national API batch into a real data directory until it has a matching official rank table, official province-level投档 baseline, and a source-registry entry that clearly says `聚合站来源，待官方复核`.
...
4. Reputable aggregators can fill gaps when official rows are unavailable or blocked. Do not label those rows as official; keep the aggregator URL and add `聚合站来源，待官方复核` in notes.
...
The current pilot data directories are `assets/pilot-data/guangdong-physics` and `assets/pilot-data/guangdong-history`. They contain real 2023, 2024, and 2025 Guangdong本科普通类投档数据, plus 2023, 2024, and 2025 ordinary score-segment rank data for the matching track imported from official PDFs/ZIP attachments. They also include 46 Guangdong public-undergraduate school coverage: 30 schools have school-official complete, near-complete, or available-year major-level imports, and 16 gap schools have aggregator/API or Workbuddy supplemental本科 rows marked for official review. Total current rows are 16634 physics and 7684 history. Use `assets/source-discovery/guangdong/major_source_inventory.csv` to distinguish `imported` official rows from `imported_aggregator` supplemental rows before counseling.
